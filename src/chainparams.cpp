...
{
    const char* pszTimestamp = "litcoinc84aa245e1866c9cca3d321847a4c4d744f5428a7278138ebb8cb1d777370f26";
...
public:
    CMainParams() {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000a1217ad6dda02e1b6ade4ab0752d3344dd938c15ae15066418a585fc3f8"));
       ...
       // vSeeds.push_back(CDNSSeedData("litcoinfoundation.com", "seeder.litcoinfoundation.com")); // litcoin
        vSeeds.push_back(CDNSSeedData("35.225.98.31", "35.225.98.31"));
